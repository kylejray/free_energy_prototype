...
$$
\\langle e^{-\\Sigma} \\rangle_C = \\frac{P_R(C^\\dagger)}{P_F(C)}
$$
...
and the term $\\ln \\frac{P_R(C^\\dagger)}{P_F(C)}$ is a correction factor that accounts for the bias introduced by selecting trajectories in class $C$.
...
## Additional Particualarly Relevant Literature
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '1rem' }}>
        ...
        <p style={{ fontSize: '1.25rem', color: 'rgba(255, 236, 224, 0.6)', maxWidth: '100%' }}>
      ...
      <div style={{
        ...
        <div className="markdown-content" style={{ color: 'rgba(255, 236, 224, 0.9)', lineHeight: '1.7' }}>
          <ReactMarkdown 
